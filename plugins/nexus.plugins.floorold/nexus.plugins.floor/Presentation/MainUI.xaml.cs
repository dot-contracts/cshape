...
using System.Linq;
using Microsoft.UI;
//using nexus.api.gaming;
using nexus.common;
using nexus.common.cache;
using nexus.common.control.uno;
using nexus.common.control.uno.Themes;
using nexus.common.dal;
//using nexus.shared.gaming;
using nexus.common.controls.Interface;
...
namespace nexus.plugins.floor
{
    public sealed partial class MainUI : NxMainUIBase, IMainUI
    {
        ...
        private async void DoSearch()
        {
            ...
            //        searchResults = await helper.Process("SwiftPos", "Pos1", Search: SearchType, Value: NumPad.Value);
            //}
