...
namespace nexus.shared.common
{
    ...
    static public class ScheduleHelpers
    {
        ...
        public static Schedule LoadFromRow(DataRow row)
        {
            ...
            {
                ScheduleId    = helpers.ToInt(row["ScheduleId"].ToString()),
                ScheduleDesc  = row["ScheduleDesc"].ToString(),
                ...
                Duration        = helpers.ToInt(row["ScheduleDur"].ToString()),
            ...
            if (schedule.ScheduleId.Equals(0))
            {
                schedule.ScheduleDesc = "Runs Always, no Schedule";
                schedule.NextRun = DateTime.Now.ToString("dd MMM, yyyy HH:mm:ss");
            }
    ...
    public class Schedule
    {
        ...
        public bool HasData()
        {
            ...
            || !string.IsNullOrEmpty(ScheduleDesc)
