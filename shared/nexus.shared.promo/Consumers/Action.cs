...
namespace nexus.shared.promo
{
    ...
    {
        public async Task<ActionResponse> Process(ActionRequest request)
        {

            ActionResponse Items = new ActionResponse();
            ...
            if (await TokenHelper.GetToken())
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    // Send a POST request to check for Actions
                    var response = await httpClient.PostAsync("pro/Action", content);
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        try
                        {
                            ...
                            Items = JsonSerializer.Deserialize<ActionResponse>(jsonString, new JsonSerializerOptions
                            {
